...
> Note 🪛 : Sửa lại cho đầy đủ để lưu trữ trong state 
...
```
> 🪛: lấy toàn bộ nhưng ở mức id thôi. Cái nào chưa có trong cache của FE thì hệ thống tự hỏi lại. 
...
```
> 🪛: giống như vậy, lấy id thôi 




### GET /life-lessons-reflection/:id
