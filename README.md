...
id (PK)
user_id (FK -> users)
life_lesson_id (FK -> life_lessons)
reflection
updated_at 
...
1. Tùy vào quy mô và cách nhìn thì hiện tại mình có các ý tưởng sau đây: 
    1. v1 là một không gian cá nhân của từng người để phục vụ cho việc đọc, học Lời dạy. 
    2. v2 là một không gian để kết nối giữa mentor và mentee trong việc học và dạy Lời dạy. 
    3. v3 là một không gian cho phép người ngoài sử dụng để giới thiệu về các triết lí cơ bản của cộng đồng (thêm một role mới là SS). 
